...
class ApiRegisterDoctorRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'colegiado'        => ['required', 'string', 'unique:users'],
    ...
    public function messages(): array
    {
        return [
            ...
            'colegiado.string'   => 'Ingrese un número de colegiado correcto.',
            'colegiado.unique'   => 'Ya existe un doctor registrado con este número de colegiado.',
